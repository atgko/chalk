...
def test_extract_passes_a_manual_table_choice_through(tmp_project, tmp_path):
    syllabus = md_builder.build_syllabus_with_multiple_candidate_tables(tmp_path / "two.md")
    course_data, _ = extract_syllabus(tmp_project, syllabus, schedule_table_index=1)
